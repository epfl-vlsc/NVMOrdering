...
bool dclWriteDataTrans(ProgramStateRef &State, const DeclaratorDecl *D, DataInfo *DI)
{
...
bool sclWriteDataTrans(ProgramStateRef &State, const DeclaratorDecl *D, DataInfo *DI)
{
...
bool sclWriteMaskTrans(ProgramStateRef &State, const DeclaratorDecl *D, CheckDataInfo *CDI)
{
    const SclState *SS = State->get<SclMap>(D);
...
bool dclFlushDataTrans(ProgramStateRef &State, const DeclaratorDecl *D, DataInfo *DI)
{
