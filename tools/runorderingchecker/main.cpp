...
static cl::OptionCategory orderingcheckerCategory{"runorderingchecker options"};

static cl::opt<std::string> databasePath{"p",
                                         cl::desc{"Path to compilation database"},
                                         cl::Optional,
                                         cl::cat{orderingcheckerCategory}};
            ...
            std::string &file)
{
  ...
  const char *SYSTEM_INCLUDES =
      "-I" LLVM_LIBRARY_DIRS "/clang/6.0.0/include/";
...
int main(int argc, char const **argv)
{
  ...
  cl::HideUnrelatedOptions(orderingcheckerCategory);
